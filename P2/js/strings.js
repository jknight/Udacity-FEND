 ...
 *
 * Udacity Reviewer: Please note that I combined serveral of these into 
 * 'templates' rather than appending lots of individual items. This is much 
 * cleaner and more flexible 
 * */

var HTMLheaderName = '<h1 id="name">%data%</h1><hr/>';
//var HTMLheaderRole = '<span>%data%</span><hr/>'; //not in use
...
//NOTE: I can't see any good reason to load this from json ? moving it directly into html
