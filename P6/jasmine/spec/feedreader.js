...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('ensure when the loadFeed function is called there is at least a single .entry', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('New feed is loaded by the loadFeedFunction & content actually changes', function(done) {
            var after = $('.feed').html();
